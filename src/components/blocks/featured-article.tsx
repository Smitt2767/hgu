    ...
    <div className="w-full px-6 py-12">
      <div className="max-w-3xl mx-auto">
        ...
        <article
          ...
          className="relative rounded-3xl overflow-hidden transition-all duration-300 cursor-pointer group bg-card focus-visible:bg-border hover:bg-border mx-4"
        >
